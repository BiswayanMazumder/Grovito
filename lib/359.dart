...
class am359 extends StatefulWidget {
  const am359({super.key});

  @override
  State<am359> createState() => _am359State();
}

class _am359State extends State<am359> {
  final player = AudioPlayer();
  Music music = Music(trackId: '2gNMXJDKRmKWuevBGjN8wo');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/new_192_3%2059%20AM%20-%20Divine.mp3';
