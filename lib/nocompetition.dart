...
class _nocompetitionState extends State<nocompetition> {
  ...
  Future<void> khattaflowLiked() async {
    ...
    if (user != null) {
      final docRef =
          _firestore.collection('No Competition Liked').doc(user.uid);
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl =
            'https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/No%20Competition.mp3';
