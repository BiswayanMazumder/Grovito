...
class _CheckitoutState extends State<Checkitout> {
  ...
  Music music = Music(trackId: '4VosVUajzm6nzGlSb6nP3L');
  ...
  Future<void> khattaflowLiked() async {
    ...
    if (user != null) {
      final docRef = _firestore.collection('Check It Out Liked').doc(user.uid);
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl = 'https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/Check-It-Out-Check-Kar.mp3';
