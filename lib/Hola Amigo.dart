...
class HolaAmigo extends StatefulWidget {
  const HolaAmigo({super.key});

  @override
  State<HolaAmigo> createState() => _HolaAmigoState();
}

class _HolaAmigoState extends State<HolaAmigo> {
  final player = AudioPlayer();
  Music music = Music(trackId: '19pHSvXUwErAXFktkvYMk9');
