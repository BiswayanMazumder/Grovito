...
class Maharani_Arpit extends StatefulWidget {
  const Maharani_Arpit({super.key});

  @override
  State<Maharani_Arpit> createState() => _Maharani_ArpitState();
}

class _Maharani_ArpitState extends State<Maharani_Arpit> {
  final player = AudioPlayer();
  Music music = Music(trackId: '7unLxuzKpxbjASww1qi4br');
  ...
  Future<void> khattaflowLiked() async {
    ...
    if (user != null) {
      final docRef = _firestore.collection('Maharani Liked').doc(user.uid);
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/Maharani_128-(DJPunjab).mp3';
