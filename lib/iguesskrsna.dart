...
class IGuess extends StatefulWidget {
  const IGuess({super.key});

  @override
  State<IGuess> createState() => _IGuessState();
}

class _IGuessState extends State<IGuess> {
  final player = AudioPlayer();
  Music music = Music(trackId: '0OxG3hlJNNzXcSrNVXEu8f');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/I%20Guess%20-%20KRSNA%20320%20Kbps.mp3';
