...
class NoCap extends StatefulWidget {
  const NoCap({super.key});

  @override
  State<NoCap> createState() => _NoCapState();
}

class _NoCapState extends State<NoCap> {
  final player = AudioPlayer();
  Music music = Music(trackId: '1XdUEm2MwB6ysy6E80ltMg');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/No%20Cap_192(PagalWorld.com.pe).mp3';
