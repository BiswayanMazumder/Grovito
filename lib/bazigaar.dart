...
class bazigaar extends StatefulWidget {
  const bazigaar({super.key});

  @override
  State<bazigaar> createState() => _bazigaarState();
}

class _bazigaarState extends State<bazigaar> {
  final player = AudioPlayer();
  Music music = Music(trackId: '1T44wPr7LUlBY4vX6LlygG');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/Baazigar_192(PagalWorldl).mp3';
