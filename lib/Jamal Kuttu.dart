...
class OneLove extends StatefulWidget {
  ...
  @override
  State<OneLove> createState() => _OneLoveState();
}

class _OneLoveState extends State<OneLove> {
  final player = AudioPlayer();
  Music music = Music(trackId: '35FFqjqaPv1Fr9B1GtJdZO');
  ...
  Future<void> khattaflowLiked() async {
    ...
    if (user != null) {
      final docRef = _firestore.collection('Jamal Kuttu Liked').doc(user.uid);
