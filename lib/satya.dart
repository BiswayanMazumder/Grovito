...
class satya extends StatefulWidget {
  const satya({super.key});

  @override
  State<satya> createState() => _satyaState();
}

class _satyaState extends State<satya> {
  final player = AudioPlayer();
  Music music = Music(trackId: '1xSCr5uIndaHKFdO4s2V6B');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/new_320_Satya%20-%20Divine.mp3';
