...
class Kalaastar extends StatefulWidget {
  const Kalaastar({super.key});

  @override
  State<Kalaastar> createState() => _KalaastarState();
}

class _KalaastarState extends State<Kalaastar> {
  final player = AudioPlayer();
  Music music = Music(trackId: '1sZFDDmmBVkcHOpV6AB0Nx');
  ...
  Future<void> khattaflowLiked() async {
    ...
    if (user != null) {
      final docRef = _firestore.collection('Kalaastar Liked').doc(user.uid);
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/Kalaastar%20-%20Yo%20Yo%20Honey%20Singh%20320%20Kbps.mp3';
