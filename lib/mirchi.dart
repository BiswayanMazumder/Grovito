...
class mirchi_dart extends StatefulWidget {
  const mirchi_dart({super.key});

  @override
  State<mirchi_dart> createState() => _mirchi_dartState();
}

class _mirchi_dartState extends State<mirchi_dart> {
  final player = AudioPlayer();
  Music music = Music(trackId: '5KkCsYIgMK5H7Ih31Dnd2Q');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/new_320_Mirchi%20-%20DIVINE.mp3';
