...
class Ykwim extends StatefulWidget {
  ...
  @override
  State<Ykwim> createState() => _YkwimState();
}

class _YkwimState extends State<Ykwim> {
  final player = AudioPlayer();
  Music music = Music(trackId: '6qS40yL7kXVoChI8SSCQIQ');
  ...
  Future<void> khattaflowLiked() async {
    ...
    if (user != null) {
      ...
      if (docSnapshot.exists) {
        // If the document exists, toggle the 'Is
        //d' field
