...
class Beenawhile extends StatefulWidget {
  const Beenawhile({super.key});

  @override
  State<Beenawhile> createState() => _BeenawhileState();
}

class _BeenawhileState extends State<Beenawhile> {
  final player = AudioPlayer();
  Music music = Music(trackId: '6FN68TXRiK095cQzv9tG5c');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/Been%20a%20While_192(PagalWorld.com.pe).mp3';
