...
class kaam25 extends StatefulWidget {
  const kaam25({super.key});

  @override
  State<kaam25> createState() => _kaam25State();
}

class _kaam25State extends State<kaam25> {
  final player = AudioPlayer();
  Music music = Music(trackId: '6Kynli1iHBqJRWUCohcV9h');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/DIVINE%20-%20Kaam%2025(KoshalWorld.Com).mp3';
