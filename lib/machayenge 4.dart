...
class Machayenge4 extends StatefulWidget {
  const Machayenge4({super.key});

  @override
  State<Machayenge4> createState() => _Machayenge4State();
}

class _Machayenge4State extends State<Machayenge4> {
  final player = AudioPlayer();
  Music music = Music(trackId: '71VXewVKFs0HcwEom489zH');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/Hola%20Amigo_192(PagalWorld.com.pe).mp3';
