...
class chorni extends StatefulWidget {
  const chorni({super.key});

  @override
  State<chorni> createState() => _chorniState();
}

class _chorniState extends State<chorni> {
  final player = AudioPlayer();
  Music music = Music(trackId: '3GEiVoaUXq468gfYs2EPfh');
  ...
  void initState() {
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        var audioUrl ='https://emkldzxxityxmjkxiggw.supabase.co/storage/v1/object/public/Grovito/Songs/Chorni_192(PagalWorld.com.pe).mp3';
